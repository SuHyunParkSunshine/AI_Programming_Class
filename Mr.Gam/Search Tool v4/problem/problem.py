...
class Problem:
    ...
    def randomInit(self):
        pass # 없어도 되긴 하지만 공통으로 쓰는 거라고 알려준다.
...
class Numeric(Problem): # Problem에서 상속을 받겠다.
    ...
    def report(self):
        ...
        print("Best Minimum value: {0:,.3f}".format(self._bestMinimum)) #self._value는 minimum을 의미
...
class Tsp(Problem):
    ...
    def report(self):
        ...
        print("Best Minimum tour cost: {0:,}".format(round(self._value)))
